...
const getCellValue = (tr, idx) => {
  ...
  d3.json(`${world}_data.json`, (error, data) => {
    ...
    const SKILLS = {"acr":"Acrobatics","ani":"Animal Handling","arc":"Arcana","ath":"Athletics","dec":"Deception","his":"History","ins":"Insight","itm":"Intimidation","inv":"Investigation","med":"Medicine","nat":"Nature","prc":"Perception","prf":"Performance","per":"Persuasion","rel":"Religion","slt":"Sleight of Hand","ste":"Stealth","sur":"Survival"};
    ...
    tabulate('#save_specific_data', data, specific_save_columns, column_name_map, column_pct_map, column_roll_fmt_map);
    tabulate('#ability_specific_data', data, specific_ability_columns, column_name_map, column_pct_map, column_roll_fmt_map);
    tabulate('#skill_specific_data1', data, skill_count_columns, column_name_map, column_pct_map, column_roll_fmt_map)
    tabulate('#skill_specific_data2', data, skill_average_columns, column_name_map, column_pct_map, column_roll_fmt_map)
